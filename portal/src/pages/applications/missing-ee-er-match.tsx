...
/**
 * A form page to re-capture the worker's SSN or ITIN and their FEIN
 * if the combination of the two did not result in a valid match.
 */
export const MissingEeErMatch = (props: WithBenefitsApplicationProps) => {
...
export default withBenefitsApplication(MissingEeErMatch);
