  ...
  return (
    <React.Fragment>
      ...
      <Heading level="2" size="1">
        {t(
          "pages.claimsAdditionalUserNotFoundInfo.beginAdditionalNoEmployerFoundInfoTitle"
        )}
      </Heading>
      <p className="display-block line-height-sans-5 measure-5 usa-intro">
        {t(
          "pages.claimsAdditionalUserNotFoundInfo.beginAdditionalNoEmployerFoundInfoDescription"
        )}
      </p>
      <ButtonLink
      ...
      >
        <div>
          {t(
            "pages.claimsAdditionalUserNotFoundInfo.beginAdditionalNoEmployerFoundInfoButton"
          )}
        </div>
      </ButtonLink>
    </React.Fragment>
