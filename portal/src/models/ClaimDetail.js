...
class ClaimDetail extends BaseModel {
  constructor(attrs) {
    ...
    if (
      ...
      this.outstanding_evidence.employee_evidence = this.outstanding_evidence.employee_evidence.map(
    ...
    if (
      ...
      this.outstanding_evidence.employer_evidence = this.outstanding_evidence.employer_evidence.map(
        (evidence) => new OutstandingEvidence(evidence)
      );
    }
  }
