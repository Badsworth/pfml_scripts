    ...
    if (!this.warnings) {
      ...
      return this.fields.every((field) => {
        ...
        const ignoredField = [
          ...
          "claim.leave_details.intermittent_leave_periods[0].frequency_interval_basis",
          "claim.leave_details.intermittent_leave_periods[0].frequency_interval",
          "claim.leave_details.intermittent_leave_periods[0].duration_basis",
          "claim.leave_details.intermittent_leave_periods[0].duration",
