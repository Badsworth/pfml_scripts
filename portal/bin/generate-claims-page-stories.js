 ...
 * and puts them in the folder: storybook/stories/pages/claims/autogenerated/.
 * Ignores claims pages that already have a story file defined in
 * storybook/stories/pages/claims/.
 */
const fs = require("fs");
const path = require("path");
const readdirp = require("readdirp");

const customStoriesDir = "storybook/stories/pages/claims";
const autogenStoriesDir = "storybook/stories/pages/claims/autogenerated";
 ...
 * If not, generate one in the storybook/stories/pages/claims/autogenerated/ folder.
 */
async function generateClaimsPageStories() {
  const claimsPageFiles = await readdirp.promise("src/pages/claims/");
...
async function generateStoryFile(storyPath) {
  ...
  await fs.promises.copyFile("bin/claims-page-story.stories.js.tpl", storyPath);
}
