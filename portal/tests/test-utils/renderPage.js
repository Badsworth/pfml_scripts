...
/**
 * @param {React.ReactElement} PageComponent - A function that returns React Component to be rendered
 ...
 *
 * @returns {import("@testing-library/react").RenderResult} RTL render function result: https://testing-library.com/docs/react-testing-library/api#render-result
 */
