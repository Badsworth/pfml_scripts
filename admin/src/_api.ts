...
export interface EmployeeSearchRequestOrderMetadata {
  by?: "created_at" | null;
  direction?: ("ascending" | "descending") | null;
}
export interface EmployeeSearchRequestPagingMetadata {
  offset?: number | null;
  size?: number | null;
}
export interface EmployeeSearchRequest {
  terms: EmployeeSearchRequestTermsMetadata;
  order?: EmployeeSearchRequestOrderMetadata | null;
  paging?: EmployeeSearchRequestPagingMetadata | null;
}
