...
3. [Running the Application (Docker)](#running-the-application-docker)
    ...
    5. [Create API DB Users](#create-application-db-users)
...
needing to work with the migrations directly, you can read more details in [the docs](/docs/api/migrations.md).
