...
Revision ID: 4e850f831b88
Revises: ef83be635653
Create Date: 2022-02-16 15:59:20.321835
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column("feature_flag_log_id", sa.Integer(), autoincrement=True, nullable=False),
        sa.Column("feature_flag_value_id", sa.Integer(), nullable=True),
        sa.ForeignKeyConstraint(
            ["feature_flag_value_id"], ["feature_flag_value.feature_flag_value_id"],
        ),
        sa.PrimaryKeyConstraint("feature_flag_log_id"),
    )
