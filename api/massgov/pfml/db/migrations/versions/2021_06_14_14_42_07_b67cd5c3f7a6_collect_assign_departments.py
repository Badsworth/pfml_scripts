...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column("department_id", sa.Text(), nullable=False), # => FINEOS ORG UNIT ID ??? 
        sa.Column("department_name", sa.Text(), nullable=True), # => same name as in fineos?
        sa.Column("tax_identifier", sa.Text(), nullable=True),
