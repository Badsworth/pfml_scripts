...
def upgrade():
    ...
    op.create_unique_constraint(
        "user_leave_administrator_id_unique",
        "link_user_leave_administrator",
        ["user_leave_administrator_id"],
    )
    op.create_table(
        "lk_user_leave_administrator_reporting_unit",
    ...
    op.create_foreign_key(
        "application_reporting_unit_id_fkey",
        "application",
        "lk_reporting_unit",
        ["reporting_unit_id"],
        ["reporting_unit_id"],
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_constraint(
        "user_leave_administrator_id_unique", "link_user_leave_administrator", type_="unique"
    )
    ...
    op.drop_table("lk_user_leave_administrator_reporting_unit")
