...
def upgrade():
    ...
    op.execute(CreateSequence(cast(str, Sequence("payment_individual_id_seq", start=1))))  # type: ignore
    op.add_column(
        "payment",
        sa.Column(
            "pub_individual_id",
    ...
    op.execute(CreateSequence(cast(str, Sequence("pub_eft_individual_id_seq", start=1))))  # type: ignore
    op.add_column(
        "pub_eft",
        sa.Column(
            "pub_individual_id",
...
def downgrade():
    ...
    op.execute(DropSequence(cast(str, Sequence("pub_eft_individual_id_seq"))))  # type: ignore
    op.drop_index(op.f("ix_payment_pub_individual_id"), table_name="payment")
    op.drop_column("payment", "pub_individual_id")
    op.execute(DropSequence(cast(str, Sequence("payment_individual_id_seq"))))  # type: ignore
