...
def upgrade():
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(["payment_details_id"], ["payment_details.payment_details_id"],),
        sa.ForeignKeyConstraint(["payment_id"], ["payment.payment_id"],),
        sa.ForeignKeyConstraint(
            ["vpei_payment_line_id"], ["fineos_extract_vpei_payment_line.vpei_payment_line_id"],
        ),
