...
WITH PAYMENT_BATCH_TRANSACTIONS AS (
    ...
    INNER JOIN FINEOS_EXTRACT_VPEI PEI ON P.VPEI_ID = PEI.VPEI_ID
...
SELECT PBT.FINEOS_CUSTOMER_NUMBER "Customer Number",
       ...
       PBT.EVENTTYPE "Overpayment Transaction Type",
...
WHERE PBT.IS_CURRENT = 'Y'
  AND PBT.CURRENT_STATE_ID IN (125)
ORDER BY PBT.EVENTTYPE