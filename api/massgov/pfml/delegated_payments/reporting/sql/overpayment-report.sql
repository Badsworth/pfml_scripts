...
WITH PAYMENT_BATCH_TRANSACTIONS AS (
    ...
    INNER JOIN FINEOS_EXTRACT_VPEI PEI ON P.FINEOS_PEI_C_VALUE = PEI.C
                                      AND P.FINEOS_PEI_I_VALUE = PEI.I
                                      AND PEI.FINEOS_EXTRACT_IMPORT_LOG_ID = P.FINEOS_EXTRACT_IMPORT_LOG_ID
