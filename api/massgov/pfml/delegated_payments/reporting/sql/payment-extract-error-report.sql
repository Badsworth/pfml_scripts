...
WITH PAYMENT_BATCH_TRANSACTIONS AS (
    SELECT P.PAYMENT_ID, P.PERIOD_START_DATE, P.PERIOD_END_DATE, P.PAYMENT_DATE,  P.AMOUNT, 
           ...
           TT.PAYMENT_TRANSACTION_TYPE_DESCRIPTION AS PAYMENT_TYPE,
    ...
    INNER JOIN LK_PAYMENT_TRANSACTION_TYPE TT ON TT.PAYMENT_TRANSACTION_TYPE_ID = P.PAYMENT_TRANSACTION_TYPE_ID
...
WHERE PBT.IS_CURRENT = 'Y'
  AND PBT.CURRENT_STATE_ID IN (120)
