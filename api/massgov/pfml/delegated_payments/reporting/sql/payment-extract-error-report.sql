...
WITH PAYMENT_BATCH_TRANSACTIONS AS (
    SELECT P.PAYMENT_ID, P.PERIOD_START_DATE, P.PERIOD_END_DATE, P.PAYMENT_DATE,  P.AMOUNT, P.LEAVE_REQUEST_DECISION,
           ...
           P.ABSENCE_CASE_CREATION_DATE,  P.FINEOS_PEI_C_VALUE,  P.FINEOS_PEI_I_VALUE,  P.FINEOS_EXTRACTION_DATE, TT.PAYMENT_TRANSACTION_TYPE_DESCRIPTION,
...
SELECT PBT.FINEOS_CUSTOMER_NUMBER "Customer Number",
       ...
       PBT.LEAVE_REQUEST_DECISION "Leave Request Decision",
       PBT.ABSENCE_CASE_CREATION_DATE "Absence Period Creation Date", 
...
WHERE PBT.IS_CURRENT = 'Y'
  AND PBT.CURRENT_STATE_ID IN (120, 180)
-- Add to Payment Error Report
