...
WITH PAYMENT_BATCH_TRANSACTIONS AS (
    SELECT P.PAYMENT_ID, P.PERIOD_START_DATE, P.PERIOD_END_DATE, P.PAYMENT_DATE,  P.AMOUNT, 
           C.FINEOS_ABSENCE_ID, C.ABSENCE_PERIOD_START_DATE, C.ABSENCE_PERIOD_END_DATE, C.CLAIM_TYPE_ID, CT.CLAIM_TYPE_DESCRIPTION,
	...
	LEFT OUTER JOIN LK_CLAIM_TYPE CT ON C.CLAIM_TYPE_ID = CT.CLAIM_TYPE_ID
