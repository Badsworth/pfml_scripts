...
SELECT 'Total (Gross) Payment Amount' "Name", to_char(SUM(PBT.AMOUNT), '999,999,990D99') "Value"
FROM PAYMENT_BATCH_TRANSACTIONS PBT WHERE PBT.IS_CURRENT = 'Y' AND PBT.CURRENT_STATE_ID IN (137, 139, 194, 198)
UNION ALL
...
FROM PAYMENT_BATCH_TRANSACTIONS PBT WHERE PBT.IS_CURRENT = 'Y' AND PBT.CURRENT_STATE_ID IN (137, 139, 194, 198)
UNION ALL
SELECT 'Federal Tax Withholding Amount' "Name", to_char(SUM(CASE WHEN PBT.CURRENT_STATE_ID IN (198) THEN PBT.AMOUNT ELSE 0 END), '999,999,990D00') "Value"
FROM PAYMENT_BATCH_TRANSACTIONS PBT WHERE PBT.IS_CURRENT = 'Y' AND PBT.CURRENT_STATE_ID IN (137, 139, 194, 198)
UNION ALL
SELECT 'Federal Tax Withholdings' "Name", to_char(SUM(CASE WHEN PBT.CURRENT_STATE_ID IN (198) THEN 1 ELSE 0 END), '999,999,990') "Value"
FROM PAYMENT_BATCH_TRANSACTIONS PBT WHERE PBT.IS_CURRENT = 'Y' AND PBT.CURRENT_STATE_ID IN (137, 139, 194, 198)
UNION ALL
SELECT 'State Tax Withholding Amount' "Name", to_char(SUM(CASE WHEN PBT.CURRENT_STATE_ID IN (194) THEN PBT.AMOUNT ELSE 0 END), '999,999,990D00') "Value"
FROM PAYMENT_BATCH_TRANSACTIONS PBT WHERE PBT.IS_CURRENT = 'Y' AND PBT.CURRENT_STATE_ID IN (137, 139, 194, 198)
UNION ALL
SELECT 'State Tax Withholdings' "Name", to_char(SUM(CASE WHEN PBT.CURRENT_STATE_ID IN (194) THEN 1 ELSE 0 END), '999,999,990') "Value"
FROM PAYMENT_BATCH_TRANSACTIONS PBT WHERE PBT.IS_CURRENT = 'Y' AND PBT.CURRENT_STATE_ID IN (137, 139, 194, 198)
UNION ALL
