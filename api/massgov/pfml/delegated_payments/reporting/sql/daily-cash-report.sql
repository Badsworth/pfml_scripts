...
FROM PAYMENT_BATCH_TRANSACTIONS PBT WHERE PBT.IS_CURRENT = 'Y' AND PBT.CURRENT_STATE_ID IN (137, 139, 207, 208)
UNION ALL
SELECT 'Federal Tax Withholdings' "Name", to_char(SUM(CASE WHEN PBT.CURRENT_STATE_ID IN (208) THEN 1 ELSE 0 END), '999,999,990') "Value"
FROM PAYMENT_BATCH_TRANSACTIONS PBT WHERE PBT.IS_CURRENT = 'Y' AND PBT.CURRENT_STATE_ID IN (137, 139, 207, 208)
UNION ALL
...
FROM PAYMENT_BATCH_TRANSACTIONS PBT WHERE PBT.IS_CURRENT = 'Y' AND PBT.CURRENT_STATE_ID IN (137, 139, 207, 208)
UNION ALL
SELECT 'State Tax Withholdings' "Name", to_char(SUM(CASE WHEN PBT.CURRENT_STATE_ID IN (207) THEN 1 ELSE 0 END), '999,999,990') "Value"
FROM PAYMENT_BATCH_TRANSACTIONS PBT WHERE PBT.IS_CURRENT = 'Y' AND PBT.CURRENT_STATE_ID IN (137, 139, 207, 208)
UNION ALL
