...
SELECT PBT.FINEOS_CUSTOMER_NUMBER "Customer Number",
       ...
       CASE WHEN PBT.PAYMENT_TRANSACTION_TYPE_DESCRIPTION = 'Standard' THEN 'Claimant'
            WHEN PBT.PAYMENT_TRANSACTION_TYPE_DESCRIPTION = 'Employer Reimbursement' THEN 'Employer'
            ELSE 'Error' END "Payment Recipient",
