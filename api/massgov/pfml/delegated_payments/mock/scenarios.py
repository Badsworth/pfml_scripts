...
class ScenarioName(Enum):
    ...
    EMPLOYER_REIMBURSEMENT_WITH_ZERO_PAYMENT = "EMPLOYER_REIMBURSEMENT_WITH_ZERO_PAYMENT"
...
class ScenarioDescriptor:
    ...
    is_employer_reimbursement_record_with_zero_payment: bool= False
    # Preapproval
...
SCENARIO_DESCRIPTORS: List[ScenarioDescriptor] = [
    ...
    ScenarioDescriptor(
        scenario_name=ScenarioName.EMPLOYER_REIMBURSEMENT_WITH_ZERO_PAYMENT,
        payment_transaction_type=PaymentTransactionType.ZERO_DOLLAR,
        payment_method=PaymentMethod.CHECK,
        fineos_extract_address_valid=True,
        is_employer_reimbursement_records_exists=True,
        is_employer_reimbursement_record_with_zero_payment = True,
    ),
