...
def get_1099_corrected_records_to_file(db_session: db.Session) -> List[Pfml1099]:
    ...
    # logger.info("Corrected query %s", correction_records)
    logger.info("Number of corrected records %s", len(correction_records))
