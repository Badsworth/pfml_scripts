...
def process_claimant_extract_data(db_session: db.Session) -> None:
...
def process_records_to_db(extract_data: ExtractData, db_session: db.Session) -> None:
    ...
    for requested_absence in requested_absences:
        ...
        try:
            ...
            if claim is not None:
                employee_pfml_entry, has_claimant_update = update_employee_info(
    ...
    logger.info("Successfully processed claimant extract data into db: %s", extract_data.date_str)
    return None
