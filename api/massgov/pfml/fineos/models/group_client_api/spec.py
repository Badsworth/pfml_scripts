...
#   timestamp: 2021-08-03T20:05:27+00:00
...
class GroupClientAccommodationDetail(BaseModel):
    ...
    createDate: Optional[date] = Field(None, description="ISO 8601 date format")
    acceptedDate: Optional[date] = Field(None, description="ISO 8601 date format")
...
class DiagnosisDetails(BaseModel):
    ...
    diagnosisDetailsId: Optional[str] = Field(
        None, description="Business Entity OID", max_length=10, min_length=0
    )
...
class NotificationDetails(BaseModel):
    ...
    lastWorkingDate: Optional[date] = Field(None, description="ISO 8601 date format")
...
class CustomerOccupation(BaseModel):
    ...
    jobEndDate: Optional[date] = Field(None, description="ISO 8601 date format")
    jobStartDate: Optional[date] = Field(None, description="ISO 8601 date format")
...
class EditMedicalDetailsCommand(BaseModel):
    ...
    symptomsFirstAppearedDate: Optional[date] = Field(None, description="ISO 8601 date format")
...
class GroupClientDocument(BaseModel):
    ...
    dateCreated: Optional[date] = Field(None, description="ISO 8601 date format")
...
class ManagedRequirementDetails(BaseModel):
    ...
    creationDate: date = Field(..., description="ISO 8601 date format")
    dateSuppressed: date = Field(..., description="ISO 8601 date format")
...
class DisabilityClaim(BaseModel):
    ...
    employerDateLastWorked: Optional[date] = Field(None, description="ISO 8601 date format")
...
class GroupClientCustomer(BaseModel):
    ...
    dateOfDeath: Optional[date] = Field(None, description="ISO 8601 date format")
...
class ReadDisabilityResult(BaseModel):
    ...
    customerDateOfBirth: Optional[date] = Field(None, description="ISO 8601 date time format")
