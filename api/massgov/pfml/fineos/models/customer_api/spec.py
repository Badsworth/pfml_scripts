...
#   filename:  customer_api.cleaned.json
#   timestamp: 2021-07-08T16:44:27+00:00
...
class EmployeeLeaveBalance(BaseModel):
    ...
    availabilityPeriodEndDate: Optional[date] = Field(
        None, description="ISO 8601 date time format", example="1999-12-31T23:59:59Z"
    )
    timeEntitlement: Optional[float] = Field(
        None,
...
class SocialSecurityDecisionResponse(BaseModel):
    ...
    applicationDate: Optional[date] = Field(
        None, description="ISO 8601 date time format", example="1999-12-31T23:59:59Z"
    )
    decisionDate: Optional[date] = Field(
        None, description="ISO 8601 date time format", example="1999-12-31T23:59:59Z"
...
class SupervisedAbsenceDetails(BaseModel):
    ...
    lastUpdatedDate: Optional[date] = Field(
        None, description="ISO 8601 date time format", example="1999-12-31T23:59:59Z"
    )
    status: Optional[str] = Field(
...
class WebMessage(BaseModel):
    ...
    messageId: Optional[int] = Field(None, description="Message Id")
    contactTime: Optional[date] = Field(
        None, description="ISO 8601 date time format", example="1999-12-31T23:59:59Z"
    )
