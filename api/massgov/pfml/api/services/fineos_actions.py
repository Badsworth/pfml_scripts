...
def send_to_fineos(
    ...
    upsert_week_based_work_pattern(fineos, fineos_web_id, application, occupation.id)
    update_occupation_details(fineos, application, occupation.id)
...
def get_customer_occupation(
...
) -> Optional[massgov.pfml.fineos.models.group_client_api.CustomerOccupation]:
    ...
    try:
        ...
        occupations = fineos_client.get_customer_occupations(fineos_web_id, customer_id).elements
        return occupations[0] if occupations is not None else None
