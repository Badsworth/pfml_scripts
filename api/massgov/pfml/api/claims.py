...
from massgov.pfml.api.services.administrator_fineos_actions import get_claim_as_leave_admin
...
def employer_get_claim_review(fineos_absence_id: str) -> flask.Response:
    """
    Calls out to the FINEOS supervisor API to retrieve claim data and returns it.
