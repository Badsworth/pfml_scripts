...
@dataclass
class WageResponse:
    filing_period: Optional[date]
    employee_id: Optional[str]
    employer_id: Optional[str]
    is_independent_contractor: Optional[bool]
    is_opted_in: Optional[bool]
    employee_ytd_wages: Optional[float]
    employee_qtr_wages: Optional[float]
    employer_med_contribution: Optional[float]
    employer_fam_contribution: Optional[float]
