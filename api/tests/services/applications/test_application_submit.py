...
def test_submit_multiple_applications_same_employee_employer(user, test_db_session):
    ...
    WagesAndContributionsFactory.create(employer=employer, employee=employee)
    application_two.first_name = application_one.first_name
    application_two.middle_name = application_one.middle_name
    application_two.last_name = application_one.last_name
