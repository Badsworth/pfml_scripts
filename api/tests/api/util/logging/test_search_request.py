...
DEFAULT_ORDER_AND_PAGING_ATTRS = {
    ...
    "order.by_length": 10,
    "order.by_type": "<class 'str'>",
    "order.direction": "descending",
    "order.direction_provided": False,
    "order.direction_length": 10,
    "order.direction_type": "<enum 'OrderDirection'>",
    "order.direction_value": "descending",
    "order.direction_name": "desc",
    "paging_fields_provided": "",
    "paging_fields_provided_length": 0,
    "paging.offset": 1,
    "paging.offset_provided": False,
    "paging.offset_type": "<class 'int'>",
    "paging.size": 25,
    "paging.size_provided": False,
    "paging.size_type": "<class 'int'>",
}
    ...
    [
        pytest.param(
            SearchEnvelope(terms=EmptyTerms()),
            {
                ...
                "request_top_level.terms_type": "<class 'tests.api.util.logging.test_search_request.EmptyTerms'>",
                "request_top_level.order_provided": False,
                "request_top_level.order_type": "<class 'massgov.pfml.api.models.common.OrderData'>",
                "request_top_level.paging_provided": False,
                "request_top_level.paging_type": "<class 'massgov.pfml.api.models.common.PagingData'>",
        ...
        pytest.param(
            SearchEnvelope(terms=ExampleSearchTerms(an_enum=ExampleEnum.FOO)),
            {
                ...
                "request_top_level_fields_provided_length": 1,
                "request_top_level.terms_provided": True,
                "request_top_level.terms_type": "<class 'tests.api.util.logging.test_search_request.ExampleSearchTerms'>",
                "request_top_level.order_provided": False,
                "request_top_level.order_type": "<class 'massgov.pfml.api.models.common.OrderData'>",
                "request_top_level.paging_provided": False,
                "request_top_level.paging_type": "<class 'massgov.pfml.api.models.common.PagingData'>",
