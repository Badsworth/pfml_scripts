...
def test_process_vcc_error_report_sent_no_vendor(
    ...
    # run process
    vcc_error_report_sent.process(test_db_session, mock_data_mart_engine)
...
def test_process_vcc_error_report_sent_success(
    ...
    run_test_process_success_no_pending_payment(
        test_db_session, mock_data_mart_engine, mocker, state_log, vcc_error_report_sent.process
    )
