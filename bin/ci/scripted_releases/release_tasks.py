...
def finalize(args):
    ...
    if git_utils.is_finalized(args.release_version):
        logger.error(f"'{args.release_version}' is already finalized.")
        logger.error("This branch is ready to take hotfixes. Try running the script with the 'hotfix' task instead.")
        return False
