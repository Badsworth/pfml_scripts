...
def parse_args(raw_args: list) -> argparse.Namespace:
    ...
    parser.add_argument("-a", "--app", choices=['admin-portal', 'api', 'portal', 'foobar'], required=True,
                        help='Are you releasing the Admin Portal, API, or Portal? (Foobar for internal testing ONLY.)')
