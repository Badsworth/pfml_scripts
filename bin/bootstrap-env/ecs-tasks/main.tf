...
module "tasks" {
  ...
  pfml_ctr_inbound_path    = "s3://massgov-pfml-$ENV_NAME-agency-transfer/ctr/inbound"
  pfml_ctr_outbound_path   = "s3://massgov-pfml-$ENV_NAME-agency-transfer/ctr/outbound"
