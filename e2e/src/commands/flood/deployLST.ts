...
import { Arguments, Options, CommandModule } from "yargs";
import { prompt } from "enquirer";
import { SystemWideArgs } from "../../cli";
import * as Util from "./common";
import * as Bundler from "./makeFloodBundle";

export type DeployLSTArgs = Util.DeployLST & SystemWideArgs;
...
export async function deploy(args: Arguments<DeployLSTArgs>): Promise<void> {
