...
export const CPS_927: ScenarioSpecification = {
  // @todo wages can be adjusted from eligible/ineligible to wage per year
  employee: { mass_id: true, wages: "eligible" },
  claim: {
    label: "CPS_SP",
    ...
    // @todo If care leave use the start, end.
    // leave_dates: [start, end],
    // @todo Requesting leave past 60 days of the initial start date.
    leave_dates: [subDays(currentDate, 10), addDays(currentDate, 61)],
    // @todo Retroactive leave past 90 days.
    // retro_leave_dates: [subDays(currentDate, 10), addDays(currentDate, -91)],
