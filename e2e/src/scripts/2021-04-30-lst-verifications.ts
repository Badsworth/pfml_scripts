...
(async () => {
  const storage = dataDirectory("2021-04-30-lst-verifications");
  ...
  try {
    ...
    (employerPool = EmployerPool.generate(5000, { family_exemption: true })),
  ...
  try {
    ...
    employeePool = EmployeePool.generate(0, employerPool, {});
