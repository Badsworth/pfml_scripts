...
function getRawEnvironment() {
  return {
    ...
    API_SNOW_CLIENT_ID: process.env.E2E_API_SNOW_CLIENT_ID,
    API_SNOW_CLIENT_SECRET: process.env.E2E_API_SNOW_CLIENT_SECRET,
    ...
    HAS_MARCH_RELEASE: process.env.HAS_MARCH_RELEASE,
    HAS_PORTAL_DASH_UPODATE_v65: process.env.HAS_PORTAL_DASH_UPODATE_v65,
  };
}
