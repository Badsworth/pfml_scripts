...
# Run fineos-import-leave-admin-org-unit task prior to pub-payments-process-fineos
# 10PM EST
module "fineos-import-leave-admin-org-unit" {
  source     = "../../modules/ecs_task_scheduler"
  is_enabled = true

  task_name                            = "fineos-import-leave-admin-org-unit"
  ...
  ecs_task_definition_arn    = aws_ecs_task_definition.ecs_tasks["fineos-import-leave-admin-org-unit"].arn
  ecs_task_definition_family = aws_ecs_task_definition.ecs_tasks["fineos-import-leave-admin-org-unit"].family
  ecs_task_executor_role     = aws_iam_role.task_executor.arn
...
module "weekend-fineos-import-leave-admin-org-unit" {
  source     = "../../modules/ecs_task_scheduler"
  is_enabled = true
