...
module "tasks" {
  ...
  payment_rejects_received_folder_path    = "s3://massgov-pfml-prod-agency-transfer/audit/inbound"
  payment_rejects_processed_folder_path   = "s3://massgov-pfml-prod-agency-transfer/audit/processed"
  payment_rejects_report_outbound_folder  = "s3://massgov-pfml-prod-agency-transfer/audit/outbound"
  payment_rejects_report_sent_folder_path = "s3://massgov-pfml-prod-agency-transfer/audit/sent"
