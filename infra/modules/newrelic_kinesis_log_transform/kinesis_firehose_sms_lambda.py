...
def transformLogEvent(log_event):
    ...
    """
    # Use regex to mask phone number in sms log message from sns logs sent by CloudWatch to Kinesis
    masked_phone_number_message = re.sub("\+1(\d{6})(\d{4})", "+1XXXXXX\\2", log_event['message']) + '\n'

    return masked_phone_number_message
